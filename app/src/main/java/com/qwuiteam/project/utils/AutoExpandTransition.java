 ...
 */
public class AutoExpandTransition extends TransitionSet {
     ...
     */
    public AutoExpandTransition() {
        init();
    }

    public AutoExpandTransition(@NonNull Context context, @NonNull AttributeSet attrs) {
        super(context, attrs);
        init();
    }
