...
public class KPSwitchConflictUtil {
    ...
    public static void attach(final Window window ,final View panelLayout,
        ...
        final Activity activity =  ViewUtil.findActivity(panelLayout.getContext());
    ...
    public static void attach(final Window window, final View panelLayout,
                              ...
                              /** Nullable **/final SwitchClickListener switchClickListener,
                              SubPanelAndTrigger... subPanelAndTriggers) {
        final Activity activity = (Activity) ViewUtil.findActivity(panelLayout.getContext());
     ...
     */
    public static boolean switchPanelAndKeyboard(final Window window ,final View panelLayout, final View focusView) {
    ...
    public static boolean isHandleByPlaceholder(boolean isFullScreen, boolean isTranslucentStatus,
        ...
        Log.d("liuyuzhe", "isFullScreen: "+isFullScreen);
        Log.d("liuyuzhe", "isTranslucentStatus: "+isTranslucentStatus);
        Log.d("liuyuzhe", "isFitsSystem: "+isFitsSystem);
